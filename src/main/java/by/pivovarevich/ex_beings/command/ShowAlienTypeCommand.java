...
public class ShowAlienTypeCommand implements Command {
    ...
    private static final String PATH_USER_ALIEN_TYPE_PAGE = "path.page.useralientype";
    ...
    public Router execute(HttpServletRequest request) {
        ...
        if("guest".equals(request.getSession().getAttribute("role"))) {
            ...
            router.setPagePath(configResourceBundle.getString(PATH_USER_ALIEN_TYPE_PAGE));
        }
